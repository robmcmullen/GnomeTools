...
import os,sys
from post_gnome.readers import read_moss as ReadMoss
# from post_gnome.kml_stuff import moss2kmz as Moss2Kmz
from post_gnome.kml_stuff import moss_kml_templates as MossKmlTemplates
...
def buildkmzSeries(mossSeriesFilename, printDiagnostic=False):
    ...
    if not Name.endswith("000"):
        raise ValueError('the last 3 chars of filename must be "000"')  #require that the last three chars of the name be "000"
    ...
    for i in range(0,999) :
        ...
        description = GetDescription(mossfilename)
    ...
    ## fixme: don't seem to have the scalebar
